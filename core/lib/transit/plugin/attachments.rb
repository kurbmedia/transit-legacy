    ...
    module Attachments
      ...
      module ClassMethods
        ...
        def attach(name, options = {})          
          ...
          apply_plugin_attribute! :"#{name.to_s}_file_name",     :type => String
          apply_plugin_attribute! :"#{name.to_s}_content_type",  :type => String
          apply_plugin_attribute! :"#{name.to_s}_file_size",     :type => Integer
          apply_plugin_attribute! :"#{name.to_s}_updated_at",    :type => Time
          apply_plugin_attribute! :"#{name.to_s}_fingerprint",   :type => String          
        end             
      end
